/**
 * Main.cpp - Integrace TerrainLoaderV5
 * =====================================
 * Načte BIN s terénem a továrnami
 * Vypíše statistiku a seznam továren
 */
...
int main(int argc, char* argv[]) {
    const char* bin_path = "terrain.bin";
    ...
    // Vytvoř loader
    TerrainLoaderV5 loader(bin_path);
 ...
 * KOMPILACE:
 * 
 * g++ -std=c++17 -O2 main.cpp -o terrain_loader
 * ./terrain_loader terrain.bin
 * 
 * Nebo s clangem:
 * clang++ -std=c++17 -O2 main.cpp -o terrain_loader
 * 
 * Pro macOS:
 * clang++ -std=c++17 -O2 -fPIC main.cpp -o terrain_loader
 */